...
const experienceData = {
  stratesys: {
      description: "As an <strong>SAP Consultant</strong>, I work on large-scale SAP implementations, focusing on cloud solutions, process optimization, and cross-functional team collaboration.<br><br>I am currently working in the international SAP implantation project for <a href='https://media.renaultgroup.com/horse-new-leading-powertrain-technology-company-is-now-fully-operational-and-ready-to-reinvent-combustion/' target='_blank'>HORSE (RENAULT’s automotive factory)</a>.",
      tech: ["sap", "office", "java"]
  },
  indie: {
      description: "I've been making simple <strong>VST3/AU</strong> plugins with the <a href='https://juce.com/' target='_blank'>JUCE framework</a> in order to satisfy my interest in audio plugins and further my understanding of <strong>DSP</strong>.<br><br>I try to recreate real pedals and sometimes even give them my own twist. To get an accurate simulation, I've found two optimal solutions:<br><li>Find an schematic and re-implement the processing with complicated matrix calculus. This is quite tedious and I'm leaving it for the future.</li><li>Use some processed recordings to train an LSTM model in order to do the heavy work for me. The final product is a bit too CPU-heavy, but both the building and the result are so satisfying that it feels like cheating.</li><br><br>I still have to build a landing webpage for this project. If you are interested in checking this out, feel free to browse my <a href='https://github.com/gmoican' target='_blank'>GitHub repos</a> or come back in a couple weeks.",
